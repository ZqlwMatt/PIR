...
from src.network import RenderingNetwork, SDFNetwork, SingleVarianceNetwork, NeRF
from src.renderer.renderer_volumn import NeuSRenderer
...
class Runner:
    def __init__(self, conf_path, mode="train", case="CASE_NAME", is_continue=False):
        ...
        # Weights
        # (Implicit Geometric Representation, IGR)
